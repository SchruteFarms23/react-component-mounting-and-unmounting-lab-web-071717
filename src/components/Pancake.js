...
class Pancake extends React.Component {
  ...
  // : create a componentDidMount() which will start the interval to count how long the pancake has been cooking
  componentDidMount(){
    this.startInterval()
  }

  // : create a componentWillUnmount() which will clear the interval
